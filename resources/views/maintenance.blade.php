...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Maintenance | Highdmin - Responsive Admin Dashboard Template</title>
                ...
                <div>
                    <div class="card-body">
                        ...
                        <div class="text-center pt-3">
                            ...
                            <h4 class="text-uppercase text-danger mt-3">Site is Under Maintenance</h4>
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted"><script>document.write(new Date().getFullYear())</script> &copy; One Stop Solution for Planters by <a href="ptpn12.com">PT Perkebunan Nusantara XII</a></p>
                        </footer>
