        ...
        $(document).ready(function() {
            ...
            tabel = $('#table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'tarif', name: 'master_zonasi.tarif' },
                    { data: 'berita_acara', "render": function ( data, type, row ) 
                        {
                            return `<button type="button" class="btn btn-success waves-effect waves-light btn-sm" onclick="tampak('${row.id}')">tampilkan BA</button>`;
                        },
                        searchable: false
                    },
                    ...
                    { data: 'posisi_id', "render": function ( data, type, row ) 
                        {
                            ...
                            if (data == 2) {
                                return `<button type="button" class="btn btn-success waves-effect waves-light btn-sm">Data Reject</button>`;
                            }
                             else {
