...
@section('content')
    ...
    <div id="modal_tambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_tambah" method="post" action="{!! url('tebu/datarenteng/store') !!}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tambah_nama" name="nama_renteng" placeholder="Nama renteng" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="tambah_nik" class="control-label">NIK</label>
                                    <input type="text" class="form-control" id="tambah_nik" name="nik" placeholder="NIK">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tambah_keterangan" name="keterangan" placeholder="Keterangan">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="modal_ubah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_ubah" method="post" action="{!! url('tebu/datarenteng/update') !!}" >
                    <div class="modal-header">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ubah_nama" name="nama_renteng" placeholder="Nama PTA">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="ubah_nik" class="control-label">NIK</label>
                                    <input type="text" class="form-control" id="ubah_nik" name="nik" placeholder="NIK">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ubah_keterangan" name="keterangan" placeholder="Keterangan">
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('customJS')
    <script type="text/javascript">
            ...
            tabel = $('#table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'status', "render": function ( data, type, row ) 
                        {
                            if (data == 1) {
                                return `<button type="button" class="btn btn-success waves-effect waves-light btn-sm" onclick="ubahStatus(${row.renteng_id}, ${data})">Aktif</button>`;
                            } else {
                                return `<button type="button" class="btn btn-danger waves-effect waves-light btn-sm" onclick="ubahStatus(${row.renteng_id}, ${data})">Tidak Aktif</button>`;
                            }
                        },
                        searchable: false
                    },
        ...
        function ubah(row) {
            $('#ubah_id').val(row.renteng_id);
            $('#ubah_nama').val(row.nama_renteng);
            $('#ubah_nik').val(row.nik);
            $('#ubah_keterangan').val(row.keterangan);
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return new Promise(function (resolve) {
                        $.ajax({
                            url: `{!! url('tebu/datarenteng/status') !!}/${id}`,
                            type: 'put',
                            data: {'status': status},
                            dataType: 'json',
